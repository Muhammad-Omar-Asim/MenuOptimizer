...
// Gold-standard reference audit. Every confirmatory check compares the first-pass
// audit against this template to ensure structure, depth, and analytical patterns
// match. The reviewer should produce a revised audit that fills gaps but does NOT
// fabricate restaurant-specific facts not supported by the menu/reports.
const GOLD_STANDARD = `
...
export default async function handler(req) {
  ...
  const prompt = `You are a senior reviewer auditing the work of another consultant. Your job is to perform a CONFIRMATORY CHECK against a known gold-standard audit template, then output a complete, REVISED audit.
