...
//
// This is the previous "elite menu growth consultant" basic prompt that
// used to power /api/analyze when mode: 'basic'. It has been retired in
// favour of the new spec in ./basic-analysis-prompt.js, but kept here
// verbatim in case we need to roll back or compare.
//
// Nothing in the app currently imports `buildOldBasicAnalysisPrompt` —
// this file is intentionally inert. To restore: change the import in
