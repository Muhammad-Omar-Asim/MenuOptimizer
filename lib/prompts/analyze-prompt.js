// First-pass audit prompt (now the only LLM pass on the Full Optimize path —
// the review/confirmatory pass has been retired).
//
// Used by /api/analyze when mode !== 'basic'. Single pass; the output is
// what the user sees on screen and what gets handed to Create PDF / Beautify.
//
// ──────────────────────────────────────────────────────────────────────────
// PLACEHOLDERS
// ──────────────────────────────────────────────────────────────────────────
