...
//
// Runs after /api/analyze on Full Optimize when the user has the "Run
// confirmatory check" toggle on. Re-produces the audit, with the first-pass
// audit injected as additional context so the model can verify and tighten
// its claims rather than starting from scratch.
//
// ──────────────────────────────────────────────────────────────────────────
// PLACEHOLDERS
// ──────────────────────────────────────────────────────────────────────────
...
//   ${finalLocation}   UI location-input value, or the Cave default
//   ${reportsBlock}    verbatim text of attached supporting reports
//   ${firstPassBlock}  the first-pass audit, wrapped with BEGIN/END markers
//
