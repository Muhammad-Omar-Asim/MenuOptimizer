...
═══════════════════════════════════════════════════════════════════════════
Your revised audit MUST contain ALL EIGHT of these top-level headings, in
this exact order, regardless of what the first-pass contains:
  ...
  ## Recommendations to Make the Menu More Navigable (with sub-sections A through F)
...
[ ] ## 3. The "Upsells" Finding — Important is present with cross-sell
    vs variant-picker classification.
...
[ ] ## Recommendations to Make the Menu More Navigable is present with
    sub-sections ### A through ### F all filled in.
[ ] ## 6. Revenue & Competitive Strategy (45-mile radius) is present
    with the five sub-sections (Competitive Landscape, Ideal placement,
    High-value upsells, Meal deals, Repeat customers).
[ ] ## Net Summary is present.
