// Old Full-Optimize / analyze prompt — preserved for future reference.
//
// This is the previous "high-value Cave consultant" prompt that used to
// power /api/analyze on Full Optimize runs. It has been retired in favour
// of the new spec in ./analyze-prompt.js, but kept here verbatim in case
// we need to roll back or compare.
//
// Nothing in the app currently imports `buildOldAnalyzePrompt` — this
// file is intentionally inert. To restore: change the import in
// api/analyze.js and api/prompts.js back to this file.

const FENCE = '────────────────────────────────────────────────────────────────';
const DEFAULT_LOCATION = '109 Saint Margarets Road, Twickenham TW1 2LH';

export function buildOldAnalyzePrompt({ menuJson, location, reports }) {
